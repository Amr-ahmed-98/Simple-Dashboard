...
const AboutProfile = () => {
  return (
    <div className='max-w-xl bg-white shadow-2xl min-h-32 rounded-2xl p-6 text-left'>
      <h2 className='text-gray-500 font-bold mb-4'>About</h2>
      ...
      <h2 className='text-gray-500 font-bold mt-8 mb-4'>Contacts</h2>
      <div className='space-y-4'>
        <div className='flex items-center gap-4'>
